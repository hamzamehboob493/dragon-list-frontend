            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-green-600 mt-1">
                  <i className="fas fa-arrow-up mr-1"></i>+12.5% from last period
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-red-600 mt-1">
                  <i className="fas fa-arrow-down mr-1"></i>-2.1% from last period
                </p>
              </div>
              ...
              {analyticsData.trafficSources.map((source, index) => (
                <div key={source.source} className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-medium text-gray-900 dark:text-white">{source.visitors.toLocaleString()}</div>
            ...
            <div className="space-y-4">
              {analyticsData.topPages.map((page, index) => (
                <div key={page.page} className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-medium text-gray-900 dark:text-white">{page.views.toLocaleString()}</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">{page.percentage}%</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border dark:border-gray-700 mt-6">
          ...
          <div className="h-64 bg-gray-50 dark:bg-gray-700 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-500 dark:text-gray-300">Interactive chart would be displayed here</p>
